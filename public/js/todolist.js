...
$(document).on('click', '#open-switch-status-modal', function () {
    ...
    const html = `
            <center>
                <button class="demo-button switch-status" data-id="0">待處理</button>
                <button class="demo-button switch-status" data-id="1">待確認</button>
                <button class="demo-button switch-status" data-id="2">已完成</button>
            </center>
        `
